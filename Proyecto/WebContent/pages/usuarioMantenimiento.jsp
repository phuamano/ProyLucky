...
/* $(document).ready(function(){
	...
	$("#idRol").val()==0;
		...
		function listaUsuario(){
			document.getElementById("idForm").action = 'listaUsuario';
			return true;
		} 
...
<div>
	<h3 class="section-title">Mantenimiento de Usuarios</h3>
</div>
<div class="row">
	<div class="col-xs-12">
			<s:form id="idForm" enctype="multipart/form-data" method="post" cssClass="form-horizontal" name="formularioCliente"> 
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="idMantDni"  placeholder="Dni" class="col-xs-10 col-sm-5"  name="usuario.dni">
						</div>
					</div>
					<div class="form-group">
			...
			<div class="form-group" align="center">	
				<div class="col-sm-9">
					...
					<sj:submit cssClass="btn btn-primary" id="idFormSalirUsu"  value="Listar" button="true" targets="idDivManUsuResultado"  formIds="idForm" onclick="javascript:listaUsuario();"/> 
